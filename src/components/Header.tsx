      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-white/90">
            ...
            <Link href="https://github.com/paybd/remitly/releases/download/remitlyeWallet_v4/remitlyeWallet-v4.apk" className="rounded-lg bg-white text-[#0067cb] px-4 py-2 text-sm font-semibold hover:bg-white/90 transition">ডাউনলোড</Link>
          </nav>
        ...
        {isMenuOpen && (
          <div className="md:hidden pb-4 border-t border-white/20">
            <nav className="flex flex-col gap-2 pt-4">
              ...
              <Link href="https://github.com/paybd/remitly/releases/download/remitlyeWallet_v4/remitlyeWallet-v4.apk" onClick={closeMenu} className="px-4 py-2 text-sm text-center rounded-lg bg-white text-[#0067cb] font-semibold hover:bg-white/90 transition">ডাউনলোড</Link>
            </nav>
          </div>
        )}
      </div>
